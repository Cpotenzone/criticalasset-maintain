const locale = {
  ...
  key_features_description:
    'Some of the features that make CriticalAsset Maintain one of the best CMMS available today',
  ...
  'work-orders.descriptions.1':
    'With CriticalAsset Maintain you can easily and quickly organize all of your Work Orders, PMs and other Tasks throughout your team in a centralized database that can be accessed anywhere on any device.',
  ...
  'work-requests.descriptions.1':
    'CriticalAsset Maintain’s maintenance management solution allows anyone you authorize to submit a problem to your maintenance department by simply scanning a QR code (bar code) or visiting a URL and typing in their request through their mobile devices.',
  ...
  'eam.descriptions.1':
    'CriticalAsset Maintain’s Enterprise Asset Management module can be used for anywhere between 10 to 1,000,000 Assets, allowing you to track exactly what you want, the way you want to, in an easy-to-use and searchable tree structure.',
  'eam.checks.0':
  ...
  'pm.descriptions.1':
    'CriticalAsset Maintain allows you to easily automate PM scheduling so the right work is automatically delivered at the right time to the right technician for the right Asset.',
  'pm.checks.0':
  ...
  'part.descriptions.1':
    'We designed CriticalAsset Maintain’s parts management to solve those problems and more:',
  'part.checks.0':
  ...
  'dashboard.descriptions.1':
    'With CriticalAsset Maintain’s Custom Dashboards you can finally start to understand that nefarious “black hole of maintenance” and begin putting data-backed plans into action, resulting in reduced labor costs, decreased downtime and more.',
  'dashboard.descriptions.2': 'With CriticalAsset Maintain’s Custom Dashboards you’ll get to …',
  ...
  'dashboard.checks.4':
    'View reports that are easily shared via Excel sheets, PDFs or within CriticalAsset Maintain',
  'dashboard.checks.5': 'And so much more ...',
  'home.smarter': 'Smarter',
  'home.work': 'Work',
  'home.smarter_description':
    'CriticalAsset Maintain makes it incredibly easy for technicians to work efficiently by giving them access to the tools and data they need to get work done — all from the palm of their hand.',
  leading_maintenance:
  ...
  no_labor:
    "No labor costs have been added yet. They'll show up here when a user logs time and has an hourly rate stored in CriticalAsset Maintain.",
  ...
  create_role_description:
    'This role can do everything an Administrator can do in CriticalAsset Maintain, but you can customize some important permissions below.',
  ...
  fill_from_voice: 'Fill from voice',
  stop_and_fill: 'Stop and fill in',
  drafting: 'Drafting…',
  ai_draft_applied: 'Title, description, and priority filled in — review before saving.',
  ai_draft_failed: "Couldn't draft from that — try again or fill in manually.",
  ai_summary: 'AI summary',
  ai_regenerate: 'Regenerate',
  ai_insights_failed: "Couldn't generate the summary right now — try again shortly.",
  ai_powered_by: 'by {{engine}}',
  ...
  number_users_who_will_use_grash: 'Number of users who will use CriticalAsset Maintain',
  admin_role: 'Admin',
  ...
  workflow_description:
    'Create custom workflows as easy as If, And, Then. Save time and easily assign your work orders automatically through workflows to customize CriticalAsset Maintain for the way your team operates.\nAll plans can create up to 1 custom workflow. To add additional workflows, upgrade to our Business plan',
  ...
  downgrade: 'Downgrade',
  upgrade_description:
    'You just upgraded your subscription plan. You need to enable the disabled users who might use CriticalAsset Maintain. You can only do this once for the current subscription. Please choose carefully',
  ...
  review_prompt_title: 'Are you enjoying CriticalAsset Maintain?',
  feedback_title: 'Help Us Improve',
  feedback_description1:
    "We're sorry to hear that. Your feedback helps us make CriticalAsset Maintain better.",
