...
<h1 align="center">CriticalAsset Maintain</h1>

CriticalAsset Maintain is a powerful, self-hosted maintenance management system designed for both
...
CriticalAsset Maintain is a fork of [Atlas CMMS](https://github.com/grashjs/cmms) (AGPL-3.0), rebranded and maintained
by CriticalAsset. See [NOTICE.md](./NOTICE.md) for what changed.
...
Go to http://localhost:3000 to access CriticalAsset Maintain.
...
| LICENSE_KEY                 | No       | Upstream (Atlas CMMS) commercial license key mechanism, inherited from the AGPL fork base. Not used by CriticalAsset Maintain.                                                                                                                                                                                      | (empty)               |
...
Not yet published — the CriticalAsset Maintain mobile app is a phase 2 item. Until then, the responsive web app
covers the mobile experience.
...
repository's Issue Tracker or email [support@criticalasset.com](mailto:support@criticalasset.com).
...
CriticalAsset Maintain is licensed under [AGPL-3.0](./LICENSE) only — free and open source. Unlike its upstream
(Atlas CMMS), it does not offer a separate commercial license; see [NOTICE.md](./NOTICE.md).

<img src="https://api.star-history.com/svg?repos=Cpotenzone/criticalasset-maintain&type=Date"/>
