const plJSON = {
  ...
  'free_cmms.title':
    'CriticalAsset Maintain Darmowe Oprogramowanie CMMS | Karta kredytowa nie jest wymagana',
  ...
  'overview.description':
    'CriticalAsset Maintain to darmowy system CMMS o otwartym kodzie źródłowym do zarządzania zleceniami pracy, konserwacją zapobiegawczą, zasobami i obiektami. Usprawnij swoje operacje konserwacyjne już dziś.',
  'overview.keywords':
    'CMMS, komputerowy system zarządzania konserwacją, EAM, zarządzanie majątkiem przedsiębiorstwa, cmms open source, darmowe oprogramowanie do konserwacji, zarządzanie zleceniami pracy, konserwacja zapobiegawcza, śledzenie zasobów, zarządzanie obiektami, oprogramowanie do śledzenia konserwacji, konserwacja sprzętu, CriticalAsset Maintain',
  'pricing.title': 'Cennik - CriticalAsset Maintain',
  'pricing.description':
    'Elastyczne plany cenowe dla CriticalAsset Maintain. Wybierz między wersją w chmurze a wersją samodzielnie hostowaną naszego CMMS typu open source, aby zoptymalizować swoje operacje konserwacyjne.',
