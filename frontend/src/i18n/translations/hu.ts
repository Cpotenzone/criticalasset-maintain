const locale = {
  ...
  'free_cmms.title':
    'CriticalAsset Maintain Ingyenes GMAO Szoftver | Nincs szükség hitelkártyára',
  ...
  'overview.description':
    'Az CriticalAsset Maintain egy ingyenes, nyílt forráskódú GMAO a munkarendelések, a megelőző karbantartás, az eszközök és a létesítmények kezelésére. Egyszerűsítse karbantartási folyamatait még ma.',
  'overview.keywords':
    'GMAO, számítógépes karbantartás-kezelő rendszer, EAM, vállalati eszközkezelés, nyílt forráskódú GMAO, ingyenes karbantartási szoftver, munkarendelés-kezelés, megelőző karbantartás, eszköz-követés, létesítménykezelés, karbantartás-követő szoftver, berendezés-karbantartás, CriticalAsset Maintain',
  'pricing.title': 'Árazás - CriticalAsset Maintain',
  'pricing.description':
    'Rugalmas árazási tervek az CriticalAsset Maintain-hez. Válasszon nyílt forráskódú GMAO rendszerünk Cloud és Self-Hosted verziói közül a karbantartási folyamatok optimalizálásához.',
