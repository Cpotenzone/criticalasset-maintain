const ruJSON = {
  ...
  'free_cmms.title':
    'Бесплатное программное обеспечение CriticalAsset Maintain | Кредитная карта не требуется',
  ...
  'overview.description':
    'CriticalAsset Maintain — это бесплатная CMMS с открытым исходным кодом для управления заказами на работу, профилактическим обслуживанием, активами и объектами. Оптимизируйте операции технического обслуживания уже сегодня.',
  'overview.keywords':
    'CMMS, компьютеризированная система управления техническим обслуживанием, EAM, управление активами предприятия, cmms с открытым исходным кодом, бесплатное программное обеспечение для технического обслуживания, управление заказами на работу, профилактическое обслуживание, отслеживание активов, управление объектами, программное обеспечение для отслеживания технического обслуживания, обслуживание оборудования, CriticalAsset Maintain',
  'pricing.title': 'Цены - CriticalAsset Maintain',
  'pricing.description':
    'Гибкие тарифные планы для CriticalAsset Maintain. Выбирайте между облачной и самостоятельной версиями нашей CMMS с открытым исходным кодом, чтобы оптимизировать операции технического обслуживания.',
