const locale = {
  ...
  ai_insights_failed: "Couldn't generate insights right now — try again shortly.",
  ai_intake_placeholder:
    'Describe the problem and let AI fill the form — e.g. "AHU-2 on the roof is leaking near the coil, needs urgent attention"',
  ai_fill: 'AI fill',
  ai_draft_applied: 'Draft applied — review and adjust before saving.',
  ai_draft_failed: "AI couldn't draft that — try rephrasing.",
